...
with st.expander('Click for: Bessel Laser Heat Source With Super Gaussian Inner Beam', expanded=True):
    ...
    Bessel_out_thickness = cm9.slider(r'''Beam ring half thickness $$(r_2$$ $$\mu m)$$''', min_value=1.0, max_value=100.0, value=20.0, step=0.01)

    # c_Ring = cm9.slider(r'$c \, \, [\mu m]$', min_value=10.0, max_value=500.0, value=70.0, step=0.01)
    # c_Ring = 70.0
    k_Bessel = cm9.slider(r'''Constant $$(k )$$''', min_value=0.0000001, max_value=10.0, value=1.0, step=0.0001)
